    ...
    <section class="flex flex-col md:flex-row gap-6">
        <div class="bg-white p-8 rounded-lg shadow-md w-full md:w-1/2">
            ...
            <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data">
                ...
                <x-inputs.text id="name" label="Name" name="name" placeholder="Enter your username" :value="old('name', $user->name)" />

                <x-inputs.text id="email" type="email" label="Email" name="email" placeholder="Enter your email"
